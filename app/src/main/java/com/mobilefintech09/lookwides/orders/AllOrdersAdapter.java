...
public class AllOrdersAdapter extends RecyclerView.Adapter<AllOrdersAdapter.OrderAdapterVH> {
    ...
    public OrderAdapterVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new OrderAdapterVH(LayoutInflater.from(context).inflate(R.layout.item_all_orders, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull AllOrdersAdapter.OrderAdapterVH holder, int position) {
